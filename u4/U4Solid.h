...
inline void U4Solid::init_Trap()
{
    ...
    if ( std::fabs(trap->GetYHalfLength1() - trap->GetYHalfLength2()) > 1e-5) assert(0);
    if ( std::fabs(trap->GetXHalfLength1() - trap->GetXHalfLength3()) > 1e-5) assert(0);
    if ( std::fabs(trap->GetXHalfLength2() - trap->GetXHalfLength4()) > 1e-5) assert(0);
    if ( std::fabs(trap->GetTanAlpha2() - trap->GetTanAlpha1()) > 1e-5) assert(0);
